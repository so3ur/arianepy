...
vitesse_x = []
position_x = []
list_Cd = [x * 0.05 for x in range(1, 11)]
coeff_list = []
hauteur_max = []
...
plt.title("hauteur max en fonction du coeff. de trainée (Méthode d'Euler) ")
plt.xlabel("Coefficient de trainée")
plt.ylabel("Hauteurcmaximale (m)")
plt.grid(True)
plt.legend()
